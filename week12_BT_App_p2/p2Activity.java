...
public class p2Activity extends Activity {
    ...
    //- UI Widget ------------------------------------------------------------
    private Button mBtBTN, mLedBTN;
    private TextView mTvUltra,mTvUltra2;
    ...
    public void clickFunc(View v) {
        switch(v.getId()) {
            ...
            case R.id.p1_led:
                ...
                sendMessage((bLEDon == false) ? "@LED,1#" : "@LED,0#");
                bLEDon = !bLEDon;
                break;
        }
    }
    ...
    private void initUI(){
        ...
        mTvUltra 	= findViewById(R.id.tv_p2_ultra);
        mTvUltra2 	= findViewById(R.id.tv_p22_ultra);
        mLedBTN		= findViewById(R.id.p1_led);
    ...
    private void setResultValue(String readMessage) {
        ...
        else if ("XLT".equals(cmd))
            mTvUltra2.setText(data);
    }
