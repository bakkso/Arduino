...
public class p3Activity extends Activity {
    ...
    //- UI Widget ------------------------------------------------------------
    private Button mBtBTN, mLedBTN,mLedBTN2,mLedBTN3;
    private TextView mTvUltra;
    private boolean bLEDon1=false;
    private boolean bLEDon2=false;
    private boolean bLEDon3=false;
    ...
    public void clickFunc(View v) {
        switch(v.getId()) {
            case R.id.btBTN:
                ...
                break;
            case R.id.p3_led1:
                ((Button) v).setTextColor((bLEDon1 == false) ? Color.RED : Color.BLACK);
                bLEDon1 = !bLEDon1;
                break;
            case R.id.p3_led2:
                ((Button) v).setTextColor((bLEDon2 == false) ? Color.RED : Color.BLACK);
                bLEDon2 = !bLEDon2;
                break;
            case R.id.p3_led3:
                ((Button) v).setTextColor((bLEDon3 == false) ? Color.RED : Color.BLACK);
                bLEDon3 = !bLEDon3;
                break;
        }
    }
    ...
    private void initUI(){
        ...
        mTvUltra 	= findViewById(R.id.tv_p3_text);
        mLedBTN		= findViewById(R.id.p3_led1);
        mLedBTN2	= findViewById(R.id.p3_led2);
        mLedBTN3	= findViewById(R.id.p3_led3);
    ...
    private void setResultValue(String readMessage) {
        ...
        if("RED".equals(cmd)) {
            ((mLedBTN)).setTextColor((bLEDon1 == false) ? Color.RED : Color.BLACK);
            bLEDon1 = !bLEDon1;
        }
        if ("BLU".equals(cmd)) {
            ((mLedBTN2)).setTextColor((bLEDon2 == false) ? Color.RED : Color.BLACK);
            bLEDon2 = !bLEDon2;
        }
        if ("GRE".equals(cmd)) {
            ((mLedBTN3)).setTextColor((bLEDon3 == false) ? Color.RED : Color.BLACK);
            bLEDon3 = !bLEDon3;
        }
        if ("ULT".equals(cmd))
