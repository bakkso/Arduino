...
import com.IoTPractice.Bluetooth.BTService;
import com.IoTPractice.data.Constant;
...
public class p4Activity extends Activity {
    ...
    //- UI Widget ------------------------------------------------------------
    private Button mBtBTN, mLedBTN,mLedBTN2,mLedBTN3,mLedBTN4,
            mLedBTN5,mLedBTN6,mLedBTN7,mLedBTN8,mLedBTN9,mLedBTN10;
        ...
        switch(v.getId()) {
            case R.id.btBTN:
                ...
                startActivityForResult(new Intent(this,
                                com.IoTPractice.DeviceListActivity.class),
                        REQUEST_CONNECT_DEVICE);
                break;
            case R.id.p4_do:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@A,1#" : "@A,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_re:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@B,1#" : "@B,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_mi:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@C,1#" : "@C,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_fa:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@D,1#" : "@D,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_ti:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@G,1#" : "@G,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_finish:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@H,1#" : "@H,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_so:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@E,1#" : "@E,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_ra:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@F,1#" : "@F,0#");
                bLEDon = !bLEDon;
                break;
            case R.id.p4_san:
                sendMessage("@SAN,1#");
            ...
            case R.id.p4_star:
                ((Button) v).setTextColor((bLEDon == false) ? Color.RED : Color.BLACK);
                sendMessage((bLEDon == false) ? "@STAR,1#" : "@STAR,0#");
                bLEDon = !bLEDon;
                break;
    ...
    private void initUI(){
        ...
        mLedBTN		= findViewById(R.id.p4_do);
        mLedBTN2	= findViewById(R.id.p4_re);
        mLedBTN3	= findViewById(R.id.p4_mi);
        mLedBTN4	= findViewById(R.id.p4_fa);
        mLedBTN5	= findViewById(R.id.p4_so);
        mLedBTN6	= findViewById(R.id.p4_ra);
        mLedBTN7	= findViewById(R.id.p4_ti);
        mLedBTN8	= findViewById(R.id.p4_finish);
        mLedBTN9	= findViewById(R.id.p4_san);
        mLedBTN10	= findViewById(R.id.p4_star);
    ...
    private void connectDevice(Intent data) {
        String address = data.getExtras().getString(com.IoTPractice.DeviceListActivity.EXTRA_DEVICE_ADDRESS);
